...
class Enqueue extends BaseController 
{
    ...
    {
        wp_enqueue_style( 'appointment_management-backend-style', $this->plugin_url . 'assets/dist/backend.styles.css' );
        wp_enqueue_script( 'appointment_management-backend-script', $this->plugin_url . 'assets/dist/backend.bundle.js' );
        ...
        wp_localize_script('appointment_management-backend-script', 'wpApiSettings', $data);
    }
    

    public function enqueue_frontend_scripts() 
    {
        wp_enqueue_style( 'appointment_management-frontend-style', $this->plugin_url . 'assets/dist/frontend.styles.css' );
        wp_enqueue_script( 'appointment_management-frontend-script', $this->plugin_url . 'assets/dist/frontend.bundle.js' );
